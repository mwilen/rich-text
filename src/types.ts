...
type TAllowedStyle = keyof Pick<CSSStyleDeclaration, 'fontSize' | 'color' | 'fontWeight'>;
export const AllowedStyles: TAllowedStyle[] = ['fontSize', 'color', 'fontWeight'];
...
export interface IFontWeightStyle extends IStyle<'fontWeight', 'bold'> {}
...
export interface IRenderedTextLine extends ITextLine, Omit<IRenderedNode, 'parent'> {
